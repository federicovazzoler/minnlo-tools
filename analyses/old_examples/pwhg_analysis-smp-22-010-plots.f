     ...
     &             150.0d0/
      ...
      call bookupeqbins('dsig_dmll',1d0,46d0,150d0)
      call bookupeqbins('dsig_dmll_F',1.d0,46d0,150d0)
      call bookupeqbins('dsig_dmll_B',1.d0,46d0,150d0)

      call bookupeqbins('NF',1.d0,0.0d0,63.0d0)
      call bookupeqbins('NB',1.d0,0.0d0,63.0d0)

      call bookup('dsig_dmll_bins',nmllbins,mllbins)
      call bookup('dsig_dmll_F_bins',nmllbins,mllbins)
      call bookup('dsig_dmll_B_bins',nmllbins,mllbins)
...
c hardest lepton
      ...
      call filld('dsig_dmll', m, dsig)
      call filld('dsig_dmll_bins', m, dsig)
      if (cll.gt.0d0) then
         call filld('dsig_dmll_F', m, dsig)
         call filld('dsig_dmll_F_bins', m, dsig)
         dsigfmb= -dsig
      else
         call filld('dsig_dmll_B', m, dsig)
         call filld('dsig_dmll_B_bins', m, dsig)
         dsigfmb= dsig
      endif

      yll_mll_bin=-1.0d0
      if(abs(yV).ge.0.0d0.and.abs(yV).lt.0.4d0)then
        yll_mll_bin=11.0*0.0d0
        if (m.ge.54.0.and.m.lt.66.0) then
          yll_mll_bin=yll_mll_bin+0.0d0
        elseif (m.ge.66.0.and.m.lt.76.0) then
          yll_mll_bin=yll_mll_bin+1.0d0
        elseif (m.ge.76.0.and.m.lt.82.0) then
          yll_mll_bin=yll_mll_bin+2.0d0
        elseif (m.ge.82.0.and.m.lt.86.0) then
          yll_mll_bin=yll_mll_bin+3.0d0
        elseif (m.ge.86.0.and.m.lt.89.5) then
          yll_mll_bin=yll_mll_bin+4.0d0
        elseif (m.ge.89.5.and.m.lt.92.7) then
          yll_mll_bin=yll_mll_bin+5.0d0
        elseif (m.ge.92.7.and.m.lt.96.0) then
          yll_mll_bin=yll_mll_bin+6.0d0
        elseif (m.ge.96.0.and.m.lt.100.0) then
          yll_mll_bin=yll_mll_bin+7.0d0
        elseif (m.ge.100.0.and.m.lt.106.0) then
          yll_mll_bin=yll_mll_bin+8.0d0
        elseif (m.ge.106.0.and.m.lt.116.0) then
          yll_mll_bin=yll_mll_bin+9.0d0
        elseif (m.ge.116.0.and.m.lt.150.0) then
          yll_mll_bin=yll_mll_bin+10.0d0
        endif
      elseif(abs(yV).ge.0.4d0.and.abs(yV).lt.0.8d0)then
        yll_mll_bin=11.0*1.0d0
        if (m.ge.54.0.and.m.lt.66.0) then
          yll_mll_bin=yll_mll_bin+0.0d0
        elseif (m.ge.66.0.and.m.lt.76.0) then
          yll_mll_bin=yll_mll_bin+1.0d0
      ...
      elseif(abs(yV).ge.0.8d0.and.abs(yV).lt.1.2d0)then
        yll_mll_bin=11.0*2.0d0
        if (m.ge.54.0.and.m.lt.66.0) then
          yll_mll_bin=yll_mll_bin+0.0d0
        elseif (m.ge.66.0.and.m.lt.76.0) then
          yll_mll_bin=yll_mll_bin+1.0d0
      ...
      elseif(abs(yV).ge.1.2d0.and.abs(yV).lt.1.6d0)then
        yll_mll_bin=11.0*3.0+7.0*0.0d0
        if (m.ge.54.0.and.m.lt.66.0) then
          yll_mll_bin=yll_mll_bin+0.0d0
        elseif (m.ge.66.0.and.m.lt.76.0) then
          yll_mll_bin=yll_mll_bin+1.0d0
        elseif (m.ge.76.0.and.m.lt.86.0) then
          yll_mll_bin=yll_mll_bin+2.0d0
        elseif (m.ge.86.0.and.m.lt.96.0) then
          yll_mll_bin=yll_mll_bin+3.0d0
        elseif (m.ge.96.0.and.m.lt.106.5) then
          yll_mll_bin=yll_mll_bin+4.0d0
        elseif (m.ge.106.5.and.m.lt.116.0) then
          yll_mll_bin=yll_mll_bin+5.0d0
        elseif (m.ge.116.0.and.m.lt.150.0) then
          yll_mll_bin=yll_mll_bin+6.0d0
        endif
      elseif(abs(yV).ge.1.6d0.and.abs(yV).lt.2.0d0)then
        yll_mll_bin=11.0*3.0+7.0*1.0d0
        if (m.ge.54.0.and.m.lt.66.0) then
          yll_mll_bin=yll_mll_bin+0.0d0
        elseif (m.ge.66.0.and.m.lt.76.0) then
          yll_mll_bin=yll_mll_bin+1.0d0
      ...
      elseif(abs(yV).ge.2.0d0.and.abs(yV).lt.2.4d0)then
        yll_mll_bin=11.0*3.0+7.0*2.0d0
        if (m.ge.54.0.and.m.lt.66.0) then
          yll_mll_bin=yll_mll_bin+0.0d0
        elseif (m.ge.66.0.and.m.lt.76.0) then
          yll_mll_bin=yll_mll_bin+1.0d0
      ...
      elseif(abs(yV).ge.2.4d0.and.abs(yV).lt.2.7d0)then
        yll_mll_bin=11.0*3.0+7.0*3.0d0+3.0*0.0d0
        if (m.ge.66.0.and.m.lt.86.0) then
          yll_mll_bin=yll_mll_bin+0.0d0
        elseif (m.ge.86.0.and.m.lt.96.0) then
          yll_mll_bin=yll_mll_bin+1.0d0
        elseif (m.ge.96.0.and.m.lt.116.0) then
          yll_mll_bin=yll_mll_bin+2.0d0
        endif
      elseif(abs(yV).ge.2.7d0.and.abs(yV).lt.3.0d0)then
        yll_mll_bin=11.0*3.0+7.0*3.0d0+3.0*1.0d0
        if (m.ge.66.0.and.m.lt.86.0) then
          yll_mll_bin=yll_mll_bin+0.0d0
        elseif (m.ge.86.0.and.m.lt.96.0) then
          yll_mll_bin=yll_mll_bin+1.0d0
      ...
      elseif(abs(yV).ge.3.0d0.and.abs(yV).lt.3.4d0)then
        yll_mll_bin=11.0*3.0+7.0*3.0d0+3.0*2.0d0
        if (m.ge.66.0.and.m.lt.86.0) then
          yll_mll_bin=yll_mll_bin+0.0d0
        elseif (m.ge.86.0.and.m.lt.96.0) then
          yll_mll_bin=yll_mll_bin+1.0d0
      ...
      if(yll_mll_bin.gt.-1.0d0)then
        if (cll.gt.0d0) then
          call filld('NF', yll_mll_bin, dsig)
        else
          call filld('NB', yll_mll_bin, dsig)
        endif
      endif
